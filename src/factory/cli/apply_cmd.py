...
async def _apply(workflow_path: str, *, force: bool = False) -> None:
    ...
    async with factory() as session:
        ...
        try:
            ...
            import factory.modules.approvals.models  # noqa: F401
            import factory.modules.api_keys.models  # noqa: F401
            import factory.modules.budgets.models  # noqa: F401
            import factory.modules.credentials.models  # noqa: F401
            import factory.modules.executions.models  # noqa: F401
            for entity_name in entity_names:
                try:
                    importlib.import_module(
                        f"factory.generated.{workflow.slug}.{entity_name}.models"
                    )
